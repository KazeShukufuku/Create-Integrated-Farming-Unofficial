...
public abstract class AbstractFishingNetContext<T extends FishingHook> {
    ...
    public void reset(ServerLevel level) {
        ...
        int lureSpeed = EnchantmentHelper.getFishingSpeedBonus(fishingRod) * 20;
        this.timeUntilCatch = (Mth.nextInt(random, 100, 600) - lureSpeed) *
    ...
    public boolean canCatch() {
        ...
        if (maxRecorded == 0)
            return true;
        return random.nextInt(maxRecorded) < visitedBlocks.size();
    }
