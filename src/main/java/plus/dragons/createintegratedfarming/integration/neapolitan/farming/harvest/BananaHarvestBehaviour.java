...
public class BananaHarvestBehaviour extends AreaCompatibleHarvestBehaviour {
    @Override
    public boolean harvestInArea(AreaHarvestContext context, BlockPos pos, BlockState state) {
        return state.is(NeapolitanBlocks.BANANA_BUNDLE.get()) && HarvestOperations.harvestFruitBlock(context, pos);
    }
}
